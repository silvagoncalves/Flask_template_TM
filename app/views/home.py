...
def list_teacher():
    ...
    return render_template('home/list_teacher.html', teachers=teachers, levels_teacher=levels_teacher, subjects_teacher=subjects_teacher, course_types=course_types)
