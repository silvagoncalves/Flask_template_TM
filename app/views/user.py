...
def count_teacher():
    ...
    db.close()
    return render_template('user/count_teacher.html', teacher=teacher, tarif_teacher=tarif_teacher, levels_teacher=levels_teacher, subjects_teacher=subjects_teacher, course_types=course_types, total=total)